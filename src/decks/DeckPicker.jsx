// src/decks/DeckPicker.jsx
import React, { useEffect, useState } from "react";
import { listDecks, createDeck } from "../data/decks";

export default function DeckPicker({ userId, open, onClose, onPick }) {
  const [loading, setLoading] = useState(false);
  const [saving, setSaving] = useState(false);
  const [decks, setDecks] = useState([]);
  const [selectedId, setSelectedId] = useState(null); // always a string
  ...
  return (
    <div className="fixed inset-0 z-[200]" id="deck-picker" data-version="v3">
      ...
      >
        <div className="flex items-center justify-between px-4 h-14 border-b">
          <div className="font-medium">Save to deck</div>
